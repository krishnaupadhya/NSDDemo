...
class NsdHelper(private var mContext: Context, private var nsdConnectionListener: NsdConnectionListener) {
    var mNsdConnectionListener: NsdConnectionListener? = null
    ...
    init {
        ...
        mNsdConnectionListener = nsdConnectionListener
    }
    ...
    private fun initializeDiscoveryListener() {
        mDiscoveryListener = object : NsdManager.DiscoveryListener {
            ...
            override fun onServiceFound(service: NsdServiceInfo) {
                ...
                mNsdConnectionListener?.onNsdServiceDiscovered(chosenServiceInfo)
    ...
    private fun initializeRegistrationListener() {
        mRegistrationListener = object : NsdManager.RegistrationListener {
            ...
            override fun onServiceRegistered(nsdServiceInfo: NsdServiceInfo) {
                ...
                mNsdConnectionListener?.onNsdServiceRegistered(nsdServiceInfo)

            }

            override fun onRegistrationFailed(nsdServiceInfo: NsdServiceInfo, arg1: Int) {
                mNsdConnectionListener?.onNsdServiceRegistrationFailed(nsdServiceInfo)
            }
